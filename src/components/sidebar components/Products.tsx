...
const Products = () => {
  ...
  return (
    <div className="flex h-[35rem] overflow-y-auto">
      <strong className="text-white  text-medium">PRODUCTS</strong>

      <div className="mt-12 px-20 flex flex-wrap gap-5 text-white">
        {popularProductsData.map((product) => (
          <Link
            to={`/product/${product.id}`}
            className="flex hover:no-underline"
          >
            <div className="flex flex-col  text-center  border-white border-4">
              <div className="w-60 h-70 min-w-10 justify-center  ">
                <img
              ...
              <div className=" flex-1 p-2 bg-blue-700">
                <p className="text-sm text-white">{product.product_name}</p>
                <span className={`text-sm font-medium`}>
                  Stock : {product.product_stock}
                </span>
              </div>
              <div className="text-sm bg-blue-700 pl-2">
